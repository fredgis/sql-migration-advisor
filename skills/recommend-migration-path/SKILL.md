...
- `https://raw.githubusercontent.com/fredgis/sql-migration-advisor/v3.10.0/docs/sql-server-to-azure-migration.md`
...
```text
Knowledge base v3.10 (bundled, same commit as the skill) · rules v3.10
```

or, when the user asked for the live document:

```text
Knowledge base v3.10 (live, fetched 2026-08-10T19:42:00Z) · rules v3.10
```
...
- Current coordinated knowledge-base line: **v3.10**, dated **2026-09-11**.
...
{
  "metadata": {
    "knowledgeBaseVersion": "v3.10",
    "decisionRulesVersion": "v3.10",
...
> KB **v3.10** · commit **n/a** · fetched **n/a**
>
