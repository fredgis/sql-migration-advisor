...
- `https://raw.githubusercontent.com/fredgis/sql-migration-advisor/v3.11.2/docs/sql-server-to-azure-migration.md`
...
```text
Knowledge base v3.11 (bundled, same commit as the skill) · rules v3.11
```

or, when the user asked for the live document:

```text
Knowledge base v3.11 (live, fetched 2026-08-10T19:42:00Z) · rules v3.11
```
...
- Current coordinated knowledge-base line: **v3.11**, dated **2026-09-11**.
...
{
  "metadata": {
    "knowledgeBaseVersion": "v3.11",
    "decisionRulesVersion": "v3.11",
...
> KB **v3.11** · commit **n/a** · fetched **n/a**
>
