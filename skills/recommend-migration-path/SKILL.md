...
- `https://raw.githubusercontent.com/fredgis/sql-migration-advisor/v2.5.0/docs/sql-server-to-azure-migration.md`
...
```text
Knowledge base v2.5 (bundled, same commit as the skill) · rules v2.5
```

or, when the user asked for the live document:

```text
Knowledge base v2.5 (live, fetched 2026-08-10T19:42:00Z) · rules v2.5
```
...
- Current coordinated knowledge-base line: **v2.5**, dated **2026-08-12**.
...
```json
{
  ...
  "knowledgeBase": { "version": "v2.5", "commit": "…", "verifiedAt": "…" },
  "engineVersion": "v2.5"
}
```
...
> KB **v2.5** · commit **n/a** · fetched **n/a**
>
