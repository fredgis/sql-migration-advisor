...
- `https://raw.githubusercontent.com/fredgis/sql-migration-advisor/v2.6.0/docs/sql-server-to-azure-migration.md`
...
```text
Knowledge base v2.6 (bundled, same commit as the skill) · rules v2.6
```

or, when the user asked for the live document:

```text
Knowledge base v2.6 (live, fetched 2026-08-10T19:42:00Z) · rules v2.6
```
...
- Current coordinated knowledge-base line: **v2.6**, dated **2026-08-12**.
...
```json
{
  ...
  "knowledgeBase": { "version": "v2.6", "commit": "…", "verifiedAt": "…" },
  "engineVersion": "v2.6"
}
```
...
> KB **v2.6** · commit **n/a** · fetched **n/a**
>
