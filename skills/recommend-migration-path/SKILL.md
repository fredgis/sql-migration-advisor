...
```text
Knowledge base v3.13 (bundled, same commit as the skill) · rules v3.13
```

or, when the user asked for the live document:

```text
Knowledge base v3.13 (live, fetched 2026-08-10T19:42:00Z) · rules v3.13
```
...
- Current coordinated knowledge-base line: **v3.13**, dated **2026-09-11**.
