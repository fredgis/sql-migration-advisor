...
- `https://raw.githubusercontent.com/fredgis/sql-migration-advisor/v2.9.0/docs/sql-server-to-azure-migration.md`
...
```text
Knowledge base v2.9 (bundled, same commit as the skill) · rules v2.9
```

or, when the user asked for the live document:

```text
Knowledge base v2.9 (live, fetched 2026-08-10T19:42:00Z) · rules v2.9
```
...
- Current coordinated knowledge-base line: **v2.9**, dated **2026-08-17**.
...
> KB **v2.9** · commit **n/a** · fetched **n/a**
>
