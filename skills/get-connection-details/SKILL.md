...
> **Status: draft, v0.4.** This skill is under design. It is not registered in any plugin
> manifest, not covered by the test suite, and must not be presented to a user as ready.
> Its knowledge base is [`docs/sql-server-to-azure-migration-connectivity.md`](../../docs/sql-server-to-azure-migration-connectivity.md) v0.4.
