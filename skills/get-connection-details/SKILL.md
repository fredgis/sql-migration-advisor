...
Knowledge base: [`docs/sql-server-to-azure-migration-connectivity.md`](../../docs/sql-server-to-azure-migration-connectivity.md) v0.9 ·
...
> KB **v0.9** · endpoint and port VERIFIED · JDBC keyword VERIFIED
>
...
> KB **v0.9** · the DNS-override behaviour is VERIFIED; the attribution to this case is a hypothesis
>
