...
- **Regression protection** — [`tests/`](tests/) holds 117 golden scenarios and 74 gates wired into CI, plus a branch-coverage floor on the decision engine so a gate cannot exist over code no scenario reaches.
...
| `SKILL.md` and its pinned fetch URL | `v3.14.4` | ✅ |
| `version.json`, `plugin.json`, `marketplace.json` | `v3.14.4` | ✅ |
...
| [Microsoft fork](https://github.com/microsoft/sql-migration-agent) | `v3.14.4` | ✅ |
| [Published rule graph](https://fredgis.github.io/sql-migration-advisor/rule-graph.html) | `v3.14.4` | ✅ |
| `howto/*.html` | — | ✅ |
...
| [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) | Deep dive: what the plugin is, how a session runs end to end, what the 74 gates defend, and where it can still be wrong. |
