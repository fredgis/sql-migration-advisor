...
| `SKILL.md` and its pinned fetch URL | `v3.14.2` | ✅ |
| `version.json`, `plugin.json`, `marketplace.json` | `v3.14.2` | ✅ |
...
| [Microsoft fork](https://github.com/microsoft/sql-migration-agent) | `v3.14.2` | ✅ |
| [Published rule graph](https://fredgis.github.io/sql-migration-advisor/rule-graph.html) | `v3.14.2` | ✅ |
| `howto/*.html` | — | ✅ |
