...
- **Regression protection** — [`tests/`](tests/) holds 110 golden scenarios and 28 gates wired into CI, plus a branch-coverage floor on the decision engine so a gate cannot exist over code no scenario reaches.
...
| `SKILL.md` and its pinned fetch URL | `v2.8.1` | ✅ |
| `version.json`, `plugin.json`, `marketplace.json` | `v2.8.1` | ✅ |
...
| [Microsoft fork](https://github.com/microsoft/sql-migration-agent) | `v2.8.1` | ✅ |
...
| [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) | Deep dive: what the plugin is, how a session runs end to end, what the 28 gates defend, and where it can still be wrong. |
