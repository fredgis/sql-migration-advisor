...
<p align="center">
  ...
  <img alt="Knowledge base v2.11" src="https://img.shields.io/badge/knowledge%20base-v2.11-2b8a3e">
...
- **Verified knowledge** — the v2.11 knowledge base is source-backed and corrected against Microsoft Learn.
...
- **Regression protection** — [`tests/`](tests/) holds 112 golden scenarios and 32 gates wired into CI, plus a branch-coverage floor on the decision engine so a gate cannot exist over code no scenario reaches.
...
| --- | --- | --- |
| [Knowledge base](docs/sql-server-to-azure-migration.md) | `v2.11` | ✅ |
| [`reference/decision-rules.md`](reference/decision-rules.md) + `.data.json` | `v2.11` | ✅ |
| `SKILL.md` and its pinned fetch URL | `v2.11.0` | ✅ |
| `version.json`, `plugin.json`, `marketplace.json` | `v2.11.0` | ✅ |
| [PDF](docs/sql-server-to-azure-migration.pdf) and its preview image | `v2.11` | ✅ |
| Poster caption and PNG | `v2.11` | ✅ |
| This README's badge and PDF sentence | `v2.11` | ✅ |
| **This table** | `v2.11` | ✅ |
| The six `blume/public/*.svg` mirrors | — | ✅ |
| [`blume/docs/index.mdx`](blume/docs/index.mdx) — the docs site | — | ✅ |
| [Microsoft fork](https://github.com/microsoft/sql-migration-agent) | `v2.11.0` | ✅ |
| [Published rule graph](https://fredgis.github.io/sql-migration-advisor/rule-graph.html) | — | ✅ |
| `howto/*.html` | — | ✅ |
| The developer pitch's sample failure block | `v2.11` | ✅ |
...
| [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) | Deep dive: what the plugin is, how a session runs end to end, what the 32 gates defend, and where it can still be wrong. |
...
v2.11, August 2026) — ready to hand to a partner or attach to a deal. It's generated reproducibly
