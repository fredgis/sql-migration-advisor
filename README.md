...
| [`docs/developer-pitch.md`](docs/developer-pitch.md) | Handover brief for a team taking over development: runtime architecture, the decision process, the CI and pull-request gates, and the known limitations. |
