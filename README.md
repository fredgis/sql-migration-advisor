...
- **Regression protection** — [`tests/`](tests/) holds 110 golden scenarios and 27 gates wired into CI, plus a branch-coverage floor on the decision engine so a gate cannot exist over code no scenario reaches.
...
| [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) | Deep dive: what the plugin is, how a session runs end to end, what the 27 gates defend, and where it can still be wrong. |
