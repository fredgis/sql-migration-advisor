...
<p align="center">
  ...
  <img alt="Knowledge base v1.14" src="https://img.shields.io/badge/knowledge%20base-v1.14-2b8a3e">
...
- **Verified knowledge** — the v1.14 knowledge base is source-backed and corrected against Microsoft Learn.
...
[`docs/sql-server-to-azure-migration.pdf`](docs/sql-server-to-azure-migration.pdf) (24 pages,
v1.14, August 2026) — ready to hand to a partner or attach to a deal. It's generated reproducibly
...
<!-- CHANGELOG:START -->
<details>
<summary><b>📓 Changelog</b> — current: <b>v1.14</b> (August 2026)</summary>
