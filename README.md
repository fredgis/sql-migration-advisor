...
- **Regression protection** — [`tests/`](tests/) holds 90 golden scenarios and 23 gates wired into CI, plus a branch-coverage floor on the decision engine so a gate cannot exist over code no scenario reaches.
