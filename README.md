...
| `SKILL.md` and its pinned fetch URL | `v2.7.1` | ✅ |
| `version.json`, `plugin.json`, `marketplace.json` | `v2.7.1` | ✅ |
...
| [Microsoft fork](https://github.com/microsoft/sql-migration-agent) | `v2.7.1` | ✅ |
