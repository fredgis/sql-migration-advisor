...
| `SKILL.md` and its pinned fetch URL | `v3.12.1` | ✅ |
| `version.json`, `plugin.json`, `marketplace.json` | `v3.12.1` | ✅ |
...
| [Microsoft fork](https://github.com/microsoft/sql-migration-agent) | `v3.12.1` | ✅ |
| [Published rule graph](https://fredgis.github.io/sql-migration-advisor/rule-graph.html) | `v3.12.1` | ✅ |
| `howto/*.html` | — | ✅ |
