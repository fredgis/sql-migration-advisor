...
- **Regression protection** — [`tests/`](tests/) holds 116 golden scenarios and 40 gates wired into CI, plus a branch-coverage floor on the decision engine so a gate cannot exist over code no scenario reaches.
...
| `SKILL.md` and its pinned fetch URL | `v3.1.0` | ✅ |
| `version.json`, `plugin.json`, `marketplace.json` | `v3.1.0` | ✅ |
...
| [Microsoft fork](https://github.com/microsoft/sql-migration-agent) | `v3.1.0` | ✅ |
...
| [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) | Deep dive: what the plugin is, how a session runs end to end, what the 40 gates defend, and where it can still be wrong. |
