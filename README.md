...
| `SKILL.md` and its pinned fetch URL | `v3.11.2` | ✅ |
| `version.json`, `plugin.json`, `marketplace.json` | `v3.11.2` | ✅ |
...
| [Microsoft fork](https://github.com/microsoft/sql-migration-agent) | `v3.11.2` | ✅ |
| [Published rule graph](https://fredgis.github.io/sql-migration-advisor/rule-graph.html) | `v3.11.2` | ✅ |
| `howto/*.html` | — | ✅ |
