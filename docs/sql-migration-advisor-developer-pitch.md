...
`FILESTREAM-PAAS`. The index at the end of `decision-rules.md` lists all 28 with the fields each one
...
flowchart LR
    ...
    W1 --> O1[actionlint · rules data --strict<br/>28 gates · 110 golden scenarios<br/>engine branch coverage >= 85%]
