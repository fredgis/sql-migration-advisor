...
>
> **Last verified.** 2026-08-14. The weekly check re-reads every source below, re-proves every
> heading anchor it cites, and re-hashes the Microsoft pages behind the volatile facts. This date
> moves only when that check has actually run.
>
